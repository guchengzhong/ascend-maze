...
export CONDA_PREFIX="/home/user2/workplace/miniconda3/envs/ascend-maze"
export PATH="${CONDA_PREFIX}/bin:${ASCEND_HOME_PATH}/bin:${ASCEND_HOME_PATH}/tools/ccec_compiler/bin:${PATH}"
export PYTHONPATH="/home/user2/workplace/Ascend-Maze/src:/home/user2/workplace/Ascend-Maze:${ASCEND_HOME_PATH}/python/site-packages:${ASCEND_HOME_PATH}/opp/built-in/op_impl/ai_core/tbe${PYTHONPATH:+:${PYTHONPATH}}"
