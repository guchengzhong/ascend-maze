...
`/home/user2/workplace/Maze/src/agentos/workflows`
...
Their smoke coverage lives in:

- `tests/test_gaia_file_workflow.py`
- `tests/test_gaia_reason_workflow.py`
- `tests/test_gaia_speech_workflow.py`
- `tests/test_gaia_vision_workflow.py`
- `tests/test_openagi_document_qa_workflow.py`
- `tests/test_openagi_image_captioning_complex_workflow.py`
- `tests/test_openagi_multimodal_vqa_complex_workflow.py`
- `tests/test_openagi_text_processing_multilingual_workflow.py`
- `tests/test_tbench_retail_cancel_workflow.py`
- `tests/test_tbench_retail_return_workflow.py`
- `tests/test_tbench_retail_modify_workflow.py`
- `tests/test_tbench_retail_cancel_modify_workflow.py`
- `tests/test_tbench_airline_book_workflow.py`
- `tests/test_tbench_airline_cancel_workflow.py`
...
Regression coverage lives in `tests/test_migrated_workflows.py`.
