...
This manual tool is intentionally outside the normal pytest path because it can
start local vLLM-Ascend services and requires Ascend hardware.  It validates the
system path, not benchmark accuracy:
